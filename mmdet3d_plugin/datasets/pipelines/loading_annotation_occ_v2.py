...
class LoadAnnotationOccV2():  # 4 scale gt_occ
    ...
    def __call__(self, results):
        ...
        if type(results['gt_occ']) is list:
            ...
            print('!!!!!!!!!!!!!Waring!!!!!!!!!!!!!!!!!!!')
            print('This Method Is Not Implement Yet')
        else:
            gt_occ = torch.tensor(results['gt_occ'])
            gt_occ_2 = torch.tensor(results['gt_occ_2'])
            gt_occ_4 = torch.tensor(results['gt_occ_4'])
            gt_occ_8 = torch.tensor(results['gt_occ_8'])
        ...
        results['gt_occ_2'] = gt_occ_2.long()
        results['gt_occ_4'] = gt_occ_4.long()
        results['gt_occ_8'] = gt_occ_8.long()

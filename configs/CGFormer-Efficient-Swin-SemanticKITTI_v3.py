...
train_pipeline = [
    ...
    dict(type='CollectData', keys=['img_inputs', 'gt_occ', 'gt_occ_2', 'gt_occ_4', 'gt_occ_8'], 
...
test_pipeline = [
    ...
    dict(type='LoadAnnotationOccV2', bda_aug_conf=bda_aug_conf, apply_bda=False,
...
model = dict(
    ...
    img_backbone=dict(
        ...
        checkpoint='/u/home/caoh/projects/MA_Jiachen/CGFormer/ckpts/efficientnet-b7_3rdparty_8xb32-aa_in1k_20220119-bf03951c.pth'),
    ),
    img_neck=dict(
        type='SECONDFPN',
    ...
    occ_encoder_backbone=dict(
        ...
        global_aggregator=dict(
            ...
            global_encoder_backbone=dict(
                ...
                init_cfg=dict(
                    type='Pretrained',
                    checkpoint='/u/home/caoh/projects/MA_Jiachen/CGFormer/ckpts/swin_tiny_patch4_window7_224.pth'),
                    ),
